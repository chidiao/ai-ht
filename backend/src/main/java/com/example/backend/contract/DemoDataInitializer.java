...
public class DemoDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        logRepository.save(new ContractFlowLog(terminated.getId(), ContractAction.TERMINATE, "李倩", ContractStatus.SUPPLIER_CONFIRMING, ContractStatus.TERMINATED, "采购项目取消，双方确认终止。"));
